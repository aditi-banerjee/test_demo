...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { contact_no: @buyer.contact_no, dob: @buyer.dob, email: @buyer.email, name: @buyer.name } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { contact_no: @buyer.contact_no, dob: @buyer.dob, email: @buyer.email, name: @buyer.name } }
